...
public class LocationXPlaceholder extends SmartChatPlaceholder {

  public LocationXPlaceholder(SmartChatAddon addon) {
    super(addon, "x");
  }
  ...
  public @Nullable String parse() {
    ...
    return DECIMAL_FORMAT.format(player.position().getX());
  }
}
