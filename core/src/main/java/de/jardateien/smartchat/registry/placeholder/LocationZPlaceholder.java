...
public class LocationZPlaceholder extends SmartChatPlaceholder {

  public LocationZPlaceholder(SmartChatAddon addon) {
    super(addon, "z");
  }
  ...
  public @Nullable String parse() {
    ...
    return DECIMAL_FORMAT.format(player.position().getZ());
  }
}
