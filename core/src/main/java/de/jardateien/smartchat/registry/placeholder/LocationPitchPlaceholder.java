...
public class LocationPitchPlaceholder extends SmartChatPlaceholder {

  public LocationPitchPlaceholder(SmartChatAddon addon) {
    super(addon, "pitch");
  }
  ...
  public @Nullable String parse() {
    ...
    return DECIMAL_FORMAT.format(player.getRotationPitch());
  }
}
